...
# ==============================================================================
# Content Hub 13F Real-Time Sync Endpoints
# ==============================================================================

@app.get("/changes/head", response_model=ChangesHeadResponse, tags=["Sync"])
...
@app.get("/changes/{source}", response_model=ChangesResponse, tags=["Sync"])
def get_changes_feed(
    ...
    try:
        # Step 1: Select batch of filings > cursor_id
        filing_query = """
            SELECT
                f.filing_id,
                f.company_id,
        ...
        # Step 3: Compute holding activities
        values_string_list = [
        ...
        # Calculate next_cursor: highest filing_id in the returned batch
...
async def stream_changes(
    ...
    async def event_generator():
        ...
        while True:
            ...
            # Keepalive comment every 20 seconds (10 iterations * 2s)
            if iteration % 10 == 0:
                yield ": keepalive\n\n"
...
def get_aggregate_stock_flow(
    ...
    -- 4. Aggregate everything together
    SELECT
